...
class Register extends Component{
    ...
    return(
        <div className="Register">
            <Link to ='/'>
            <img className="Register_logo" src={eleshop} alt=""/>
            </Link>
            <div className ='Register_container'>
                ...
                <form>
                    ...
                    <input type="text" placeholder="Address...... " name="address" id="address" value={this.state.address} onChange={(event)=>{this.setState({address : event.target.value})}} required/>
